...
资料说明：本篇使用已审阅的实机录屏画面与此前 Pop! Slots 研究。截图做了必要遮盖，画面观察、此前判断与尚未确认的内容分别说明。

## 八、机器人：DSH 到底发现了什么

此前 DSH 的研究不只是觉得“人物看起来像机器人”，还发现了人物资料中几种同时出现的规律。因此，原研究认为 Pop 很可能在多人大厅中加入模拟人物，补充热闹程度。下面保留具体发现，方便策划理解这个判断从何而来。

### 人物资料里有哪些规律

| DSH 原报告记录的发现 | 为什么会引起注意 | 这条发现能说明到哪里 |
| --- | --- | --- |
| 用户编号（UID）集中 | 原报告记为28个编号中的25个落在很接近的一小段，末尾接近连续 | 看起来像同一批建立的身份，是批量补人判断的线索；仅凭编号仍不能认定某人是机器人 |
| 地区明显集中 | 原报告记为28份地区资料中25份为美国 | 与编号集中一起出现，让“统一准备的一批人物”更值得怀疑；不是所有人都在美国，也不代表整个游戏的地区分布 |
| 出现 Guest 加数字的名字 | 部分名字像自动生成的游客名 | 可以作为资料模板化的线索，但真人也可能使用游客名 |
| 姓氏重复 | 原报告举出了不同名字使用相同姓氏的情况 | 提醒我们留意名字库的重复感；少数同姓人物本身不是机器人证明 |
| 部分名字位置显示国家名 | 有些记录读到的是国家名，而不是通常的人名 | 原研究把它列为异常，也可能是资料理解有误；不能据此断定这些人物没有名字 |

这些发现来自 DSH 已有研究，不是本次录屏直接显示的信息。原报告总述提到29份人物资料，上面两项统计又使用28份，数量口径尚未对齐。因此保留“编号与地区高度集中”等发现，不把25/28写成大厅机器人比例，也不据此判断某个具体人物的身份。这里不展示原人物的完整编号、姓名和金额。

### 这些线索怎样连成一个大厅解释

| 观察角度 | 此前研究认为 | 策划可以借此理解什么 |
| --- | --- | --- |
| 人从哪里来 | 大厅有多人同场的基础，并可能用模拟人物补人数 | 真人不足时，仍能让机台附近有人活动 |
| 人看起来是谁 | 模拟人物也带有编号、名字、地区和其他资料 | 只有外形变化还不够，资料重复或前后变化也会影响人物的连贯感 |
| 人在做什么 | 原研究把活动概括为站立、走向机台、落座游玩、庆祝和离开 | 可以把热闹理解为不同人物持续活动，而不只是摆满椅子 |

其中，完整活动过程是此前研究整理出的解释。本次画面能直接看到站立、转向、走动、在座人物和中奖提示，但没有完整看到同一名已确认机器人从入场一直活动到离场。具体如何补位、何时换台、玩家靠近时是否让座，仍未确认。

### 对策划最有用的提醒

人物的外观、名字、地区与资料需要一起看。若一批人名字形式相似、地区高度集中，又以同样节奏活动，玩家更容易把它们看成一批重复的装饰；这一点是设计上的提醒，不是本次已测得的玩家反馈。

借鉴重点是让虚构人物有稳定身份、合乎设定的资料和错开的活动节奏。用户编号规律用于理解 DSH 的判断，不应直接变成“把编号打散就算设计好了”的要求；也不照搬竞品人物身份或地区比例。

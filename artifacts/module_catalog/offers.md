...
- Primary live samples: **34** from `20260825_182300`
- Cross-cutting live samples: **11**
- Live endpoints / schema endpoints: **6 / 15**
- Live populated field paths: **129**
...
| `AppServer.StartPersonalOffer` | `Casino.StartPersonalOfferRequest` | `Casino.StartPersonalOfferResponse` | 1 | 1 | observed-live |
| `AppServer.DiscardPersonalOffer` | `Casino.EmptyRequest` | `Casino.EmptyResponse` | 1 | 0 | observed-live |
| `AppServer.TriggerDirectPurchaseOffer` | `Casino.TriggerDirectPurchaseOfferRequest` | `Casino.TriggerDirectPurchaseOfferResponse` | 2 | 2 | observed-live |
...
| `AppClient.UpdateShop` | `Casino.UpdateShopRequest` | `Casino.UpdateShopResponse` | 12 | 12 | observed-live |
| `AppClient.UpdatePersonalOfferGlobals` | `Casino.UpdatePersonalOfferGlobalsRequest` | `Casino.EmptyResponse` | 0 | 0 | schema-only |
| `AppClient.AddPersonalOffer` | `Casino.AddPersonalOfferRequest` | `Casino.EmptyResponse` | 0 | 0 | schema-only |
| `AppClient.CancelPersonalOffer` | `Casino.CancelPersonalOfferRequest` | `Casino.EmptyResponse` | 0 | 0 | schema-only |
| `AppClient.UpdateDirectPurchaseOffer` | `Casino.UpdateDirectPurchaseOfferRequest` | `Casino.EmptyResponse` | 0 | 0 | schema-only |
...
- `AppClient.UpdateShop` — 24 (12 request, 12 response)
- `AppServer.TriggerDirectPurchaseOffer` — 4 (2 request, 2 response)
- `AppServer.CollectShopBonus` — 2 (1 request, 1 response)
- `AppServer.StartPersonalOffer` — 2 (1 request, 1 response)
- `AppServer.DiscardPersonalOffer` — 1 (1 request, 0 response)
...
|---|---:|---:|---:|---|
| `Casino.UpdateShopRequest.dci_config_info.identifier.config_id` | 12 | 12 | 2 | varying-in-session |
| `Casino.UpdateShopRequest.dci_config_info.identifier.flags` | 12 | 12 | 1 | constant-in-session |
| `Casino.UpdateShopRequest.dci_config_info.segment_id` | 12 | 12 | 2 | varying-in-session |
...
| `Casino.UpdateShopRequest.product[].custom_fields` | 12 | n/a | n/a | not-assessed |
| `Casino.UpdateShopRequest.product[].custom_fields.custom_field_1` | 12 | 84 | 5 | varying-in-session |
| `Casino.UpdateShopRequest.product[].custom_fields.custom_field_3` | 12 | 84 | 3 | varying-in-session |
| `Casino.UpdateShopRequest.product[].product_id` | 12 | 108 | 10 | varying-in-session |
...
| `Casino.UpdateShopRequest.product[].reward_data[].reward.extra_item_boost.time.duration` | 12 | 120 | 5 | varying-in-session |
| `Casino.UpdateShopRequest.product[].reward_data[].reward.extra_item_boost.time.expire_time` | 12 | 120 | 1 | constant-in-session |
| `Casino.UpdateShopRequest.product[].reward_data[].reward.extra_item_boost.time.value` | 12 | 120 | 2 | varying-in-session |
| `Casino.UpdateShopRequest.product[].reward_data[].reward.extra_item_boost.type` | 12 | 120 | 2 | varying-in-session |
| `Casino.UpdateShopRequest.product[].reward_data[].reward.id` | 12 | 444 | 8 | varying-in-session |
...
| `Casino.UpdateShopRequest.product[].tag[]` | 12 | 116 | 6 | varying-in-session |
| `Casino.UpdateShopRequest.shop_promotion.dci_config_info.identifier.config_id` | 12 | 12 | 2 | varying-in-session |
| `Casino.UpdateShopRequest.shop_promotion.dci_config_info.identifier.flags` | 12 | 12 | 1 | constant-in-session |
| `Casino.UpdateShopRequest.shop_promotion.dci_config_info.segment_id` | 12 | 12 | 2 | varying-in-session |
| `Casino.UpdateShopRequest.shop_promotion.expire` | 12 | 12 | 1 | constant-in-session |
| `Casino.UpdateShopRequest.shop_promotion.promo_iap[].product_id` | 12 | 84 | 8 | varying-in-session |
...
| `Casino.UpdateShopRequest.shop_promotion.promo_iap[].promo_reward[].reward.extra_item_boost.time.duration` | 12 | 120 | 5 | varying-in-session |
| `Casino.UpdateShopRequest.shop_promotion.promo_iap[].promo_reward[].reward.extra_item_boost.time.expire_time` | 12 | 120 | 1 | constant-in-session |
| `Casino.UpdateShopRequest.shop_promotion.promo_iap[].promo_reward[].reward.extra_item_boost.time.value` | 12 | 120 | 2 | varying-in-session |
| `Casino.UpdateShopRequest.shop_promotion.promo_iap[].promo_reward[].reward.extra_item_boost.type` | 12 | 120 | 2 | varying-in-session |
| `Casino.UpdateShopRequest.shop_promotion.promo_iap[].promo_reward[].reward.id` | 12 | 396 | 5 | varying-in-session |
| `Casino.UpdateShopResponse.identifier.config_id` | 12 | 12 | 2 | varying-in-session |
| `Casino.UpdateShopResponse.identifier.flags` | 12 | 12 | 1 | constant-in-session |
| `Casino.UpdateShopResponse.status` | 12 | 12 | 1 | constant-in-session |
| … | | | | 89 more rows in `fields.csv` |
